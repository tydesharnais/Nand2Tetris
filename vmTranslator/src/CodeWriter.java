...
public class CodeWriter {
    ...
    // DESCRIPTION:		informs the code writer of the new vm file
    // PRE-CONDITION:	takes the fileName of the file
    // POST-CONDITION:	sets the file name
    public void setFileName(String fileName) {
        this.fileName = fileName;
    }

    // DESCRIPTION:		writes the assembly code that is the translation of the given arithmetic command
    // PRE-CONDITION:	takes a string of the command
    // POST-CONDITION:	prints the correct line
    ...
    // DESCRIPTION:		writes the assembly code that is the translation of the given logic command
    // PRE-CONDITION:	takes a string of the operator
    // POST-CONDITION:	prints the correct line
    ...
    // DESCRIPTION:		writes the assembly code that is the translation of the given command  C_PUSH or C_POP
    // PRE-CONDITION:	takes in the command, the string segment and the index
    // POST-CONDITION:	prints the correct line
    ...
    // DESCRIPTION:		pops from the stack for symbols that point to base addresses of virtual segments
    // PRE-CONDITION:	takes in the index and the string
    // POST-CONDITION:	prints the correct line
    ...
    // DESCRIPTION:		pushes onto the stack for symbols that point to base addresses of virtual segments
    // PRE-CONDITION:	takes in the index and the string
    // POST-CONDITION:	prints the correct line
    ...
    // DESCRIPTION:		pops from the stack for segments mapped directly onto RAM
    // PRE-CONDITION:	takes in the location string
    // POST-CONDITION:	prints the correct line
    ...
    // DESCRIPTION:		pushes onto the stack for segments mapped directly onto RAM
    // PRE-CONDITION:	takes in the location string
    // POST-CONDITION:	prints the correct line
    ...
    // DESCRIPTION:		pushes the value in D onto the stack and increments stack pointer
    // PRE-CONDITION:	Called
    // POST-CONDITION:	prints the correct line
    ...
    // DESCRIPTION:		gets the value at the top of the stack, stores it in D, and decrements stack pointer
    // PRE-CONDITION:	Called
    // POST-CONDITION:	prints the correct line
